...
/**
 * Parse the assets of a single "Scratch object" and load them.
 ...
 */
const parseScratchAssets = function (object, runtime, extensions, topLevel, zip) {
    const assets = {
        costumePromises: [],
        soundPromises: [],
    ...
    if (object.children) {
        for (let m = 0; m < object.children.length; m++) {
            childrenAssets.push(parseScratchAssets(object.children[m], runtime, extensions, false, zip));
        }
    }
...
const sb2import = function (json, runtime, optForceSprite, zip) {
    ...
    return Promise.resolve(parseScratchAssets(json, runtime, extensions, !optForceSprite, zip))
