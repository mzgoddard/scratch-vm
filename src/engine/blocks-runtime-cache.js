...
class RuntimeScriptCache {
    constructor (container, blockId) {
         ...
         * runtime.
         *
         * This copy of the fields or the fields of all inputs is created and
         * modified changing the case of strings to uppercase. Part of this is
         * to make sure we do not overwrite the fields stored in the raw block.
         * @type {object}
         */
